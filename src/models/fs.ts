...
export class FileEntry extends Aspect {
    ...
    static override async create({ _, path }: AspectDataRequiredAndOptionalProperties<FileEntry, "path">): Promise<FileEntry> {
...
export class Directory extends FileEntry {
    static override async create({ _, ...fileEntry }: AspectDataRequiredAndOptionalProperties<File, keyof FileEntry>): Promise<Directory> {
...
export class File extends FileEntry {
    ...
    static override async create({ _, hash, ...fileEntry }: AspectDataRequiredAndOptionalProperties<File, keyof FileEntry/* "path" | "stats" */>): Promise<File> {
